...
<form action="Booking" method="post">
	...
	<tr><td>Booking Name:</td><td><input type="text" name="name" value="${bookinfo.bookName}" required/></td></tr>
	<tr><td>Booking Time:</td>
	<td align="center">
	
	<%-- start time --%>
	<div class='input-group date' id='datetimepickerstart'>
        <input type='text' class="form-control" name="start" id="start" placeholder="Start time" value="<fmt:formatDate value="${bookinfo.bookStart}" pattern="dd/MM/yyyy HH:mm" />" required/>
	...
	<div class='input-group date' id='datetimepickerend'>
       <input type='text' class="form-control" name="end" id="end" placeholder="End time" value="<fmt:formatDate value="${bookinfo.bookEnd}" pattern="dd/MM/yyyy HH:mm" />" required/>
       <span class="input-group-addon">
           <span class="glyphicon glyphicon-calendar"></span>
       </span>
    </div>
