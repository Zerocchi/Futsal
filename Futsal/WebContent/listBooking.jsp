...
<div class="col-md-9 first">
	...
	<div class="panel-body" align="center">You might want to <a href="Booking?action=add">add new booking</a></div>
			...
			Select date and time:
	            ...
	            <div class="form-group">
	                <div class='input-group date' id='datetimepicker1'>
	                    ...
	                    value="<fmt:formatDate value="${datetime}" pattern="dd/MM/yyyy HH:mm" />" required/>
